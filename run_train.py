...
def _run(rank, world_size, cfg):
    ...
    noise = (
        DDP(noise, device_ids=[rank], static_graph=True)
        if world_size > 1
    ...
    train_ds, eval_ds = data.get_dataloaders(cfg, distributed=(world_size > 1))
            ...
            if (
                ...
                if cfg.training.snapshot_sampling:
                    ...
                    file_name = os.path.join(
                        this_sample_dir, f"sample_{rank}.txt"
                    )
